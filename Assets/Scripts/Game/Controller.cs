...
namespace Bones.Game
{
    public sealed class Controller : MonoBehaviour
    {
        ...
        private float _rotationSensitivity = 70;
        ...
        private void Update()
        {
            ...
            this._direction = Quaternion.AngleAxis(this._rotationSensitivity * rotation * Time.deltaTime, Vector3.up) * this._direction;
        }
